...
export default class AboutComponent extends Component {
  ...
  view = (state) => {
    return <div class="about">
      ...
      <p>The text editor used was the wonderful BBEdit on macOS. To get the smoothest developer experience while editing the Classy-UI properties, however, it may be a considerable advantage using an editor with TypeScript Language Server support.</p>
